...
cat("## About: ","\n\n")
last_i <- 3  # initialize to any value; is used to start next loop 
...
cat(" __Used template:__ ", "This study protocol is based on the preregistration template for scoping reviews (version 2).", "\n\n", sep ="")
...
for (i in last_i:length(params$answers)) # loop durch alle items
{
